...
export default function ArgusPostClient({ post, user }: ArgusPostClientProps) {
  ...
  return (
    <div data-area="argus" className="min-h-screen bg-background pt-16">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <article>
          <header className="mb-8">
            {post.document_type && (
              <div className="mb-4">
                <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-indigo-100 dark:bg-indigo-900/20 text-indigo-700 dark:text-indigo-300">
