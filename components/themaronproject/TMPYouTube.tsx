    ...
    return (
      <section className={cn("py-12", className)}>
        <div className="flex flex-col items-center justify-center text-center px-6">
          ...
          <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">Stories Coming Soon</h3>
          ...
          <div className={cn(
            ...
            <AnimatePresence mode="popLayout">
              {currentVideos.map((video, index) => (
                ...
                >
                  {viewMode === 'grid' ? (
                    <div className="overflow-hidden rounded-xl bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700/50 hover:border-gray-300 dark:hover:border-gray-600 transition-all duration-200 hover:shadow-md">
                      ...
                      <div className="p-3">
                        ...
                        <h4 className="font-medium text-gray-900 dark:text-white text-sm line-clamp-1 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                          {video.title}
                        </h4>
                      </div>
                    </div>
                  ) : (
                    <div className="flex items-center gap-4 p-3 rounded-xl bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700/50 hover:border-gray-300 dark:hover:border-gray-600 transition-all duration-200 hover:shadow-md">
                      ...
                      <div className="flex-1 min-w-0">
                        <h4 className="font-medium text-gray-900 dark:text-white text-sm sm:text-base line-clamp-1 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                          {video.title}
                        </h4>
                        ...
                        {video.description && (
                          <p className="text-xs text-gray-600 dark:text-gray-400 line-clamp-1 mt-1.5 hidden sm:block">
                            {video.description}
                          </p>
                        )}
                      </div>
        ...
        {totalPages > 1 && (
          <motion.div variants={itemVariants} className="flex items-center justify-center gap-2 px-4 sm:px-6 pt-4">
            <button
              ...
              className="flex items-center gap-1 px-3 py-1.5 rounded-lg text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800 disabled:opacity-40 disabled:cursor-not-allowed transition-all"
            >
